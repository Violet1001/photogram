				...
				<center><form action='valida_login.php' method='post' enctype='multipart/form-data' class='needs-validation' novalidate>
					<div id='formulario_login' class='border w-50 pb-3 pt-3'>
						<label for='username' for='validationCustom01'>Usuario: </label>
							<input type='text' class='form-control text-capitalize' id='validationCustom01' placeholder='Usuario...' name = 'usuario' id='username'  required="required"/>
						<div class='invalid-feedback'>
							Login inválido.
						</div>
								<br/>
						<label for='pass' for='validationCustom02'>Senha: </label>
							<input type='password' class='form-control' id='validationCustom02' placeholder='Senha......' name='senha' id='pass'  required="required"/>
						<div class='invalid-feedback'>
							Senha inválida.
						</div>
						<?php
