	...
	if(isset($_SESSION["validado"])){
		...
		echo"<div class='container-fluid'>
				...
				<form  action = 'cadastro.php' method = 'POST' class='needs-validation' novalidate>
					...
					<input type='text' class='form-control text-capitalize' id='validationCustom01' placeholder='Nome' name = 'nome'  required>
					...
					<input type='text' class='form-control text-capitalize' id='validationCustom02' placeholder='Sobrenome' name = 'sobrenome' required>
					<div class='invalid-feedback'>
					Por favor, coloque seu sobrenome.
					</div>
					</div>
					<div class='col-md-4 mb-3'>
					...
					<input type='password' class='form-control' id='validationCustom04' placeholder='Senha' required name = 'senha' />
					<div class='invalid-feedback'>
					...
					<input type='date' class='form-control' id='validationCustom04' required name = 'data_nascimento' />
					<div class='invalid-feedback'>
